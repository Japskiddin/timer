    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_STOPWATCH) {
            itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.card_stopwatch, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder myHolder, int position) {
        switch (myHolder.getItemViewType()) {
            case TYPE_STOPWATCH: {
                ...
                holder.digital_clock.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "DS-DIGI.TTF"));
        ...
        public boolean onTouch(View view, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN: {
                    view.getBackground().setColorFilter(0xe0f47521, PorterDuff.Mode.SRC_ATOP); // TODO: подумать над анимацией
                    view.invalidate();
                    break;
                }
