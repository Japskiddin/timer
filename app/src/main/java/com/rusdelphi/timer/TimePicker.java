 ...
 * vertical spinners.
 *
 * The hour can be entered by keyboard input.  Entering in two digit hours can be accomplished by
 * hitting two digits within a timeout of about a second (e.g. '1' then '2' to select 12).
 *
 * The minutes can be entered by entering single digits. The seconds can be entered by entering
 * single digits.
 *
...
public class TimePicker extends FrameLayout {
  ...
  public TimePicker(Context context, AttributeSet attrs, int defStyle) {
    ...
    inflater.inflate(R.layout.time_picker_widget, this, // we are the parent
        true);
    ...
    mMinutePicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
      @Override public void onValueChange(NumberPicker spinner, int oldVal, int newVal) {
  ...
  public long getCurrentMillis() {
    return (getCurrentHour() * 3600 + getCurrentMinute() * 60 + getCurrentSeconds()) * 1000;
  }
