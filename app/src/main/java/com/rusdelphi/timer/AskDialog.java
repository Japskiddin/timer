  ...
  @Override public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    if (mRateDialog) {
      builder.setMessage(R.string.Vote_text)
          .setPositiveButton(R.string.Vote_text_ok, new DialogInterface.OnClickListener() {
            @Override public void onClick(DialogInterface dialog, int which) {
              ...
              if (!MyStartActivity(intent)) {
                ...
                if (!MyStartActivity(intent)) {
                  ...
                  Toast.makeText(getActivity(), R.string.Market_error, Toast.LENGTH_SHORT).show();
                }
              }
            }
          })
          .setNegativeButton(R.string.Vote_text_cancel, new DialogInterface.OnClickListener() {

            @Override public void onClick(DialogInterface dialog, int which) {
              MainActivity.mAskRate = false;
            }
          })
          .setNeutralButton(R.string.Text_later, new DialogInterface.OnClickListener() {
    ...
    if (mSharedDialog) {
      builder.setMessage(R.string.Share_text_ask)
          .setPositiveButton(R.string.Share_text_ok, new DialogInterface.OnClickListener() {
            @Override public void onClick(DialogInterface dialog, int which) {
              ...
              if (canShareText(true, share)) {
                startActivityForResult(Intent.createChooser(share, getString(R.string.Share_via)),
                    0);
              } else {
          ...
          .setNegativeButton(R.string.Share_text_cancel, new DialogInterface.OnClickListener() {
