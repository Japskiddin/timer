 ...
 * App Widget Configuration implemented in {@link StopwatchWidgetConfigureActivity StopwatchWidgetConfigureActivity}
 */
    ...
    private static class UpdateService extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            for (int widgetId : allWidgetIds) {
                int stopwatchId = StopwatchWidgetConfigureActivity.getStopwatch(getApplicationContext(), widgetId);
                ...
                // Construct the RemoteViews object
                RemoteViews views = new RemoteViews(getApplicationContext().getPackageName(), R.layout.stopwatch_widget);
                views.setInt(R.id.WidgetRoot, "setBackgroundResource", R.drawable.layout_corners);
                ...
                if (stopwatch != null) {
                    ...
                    PendingIntent startIntent = PendingIntent.getService(getApplicationContext(), widgetId, clickIntent, PendingIntent.FLAG_CANCEL_CURRENT);
                    views.setOnClickPendingIntent(R.id.start_button_widget, startIntent);
                }
